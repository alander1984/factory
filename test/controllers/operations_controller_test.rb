...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { name: @operation.name, special: @operation.special, workshop_id: @operation.workshop_id }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { name: @operation.name, special: @operation.special, workshop_id: @operation.workshop_id }
    assert_redirected_to operation_path(assigns(:operation))
  end
